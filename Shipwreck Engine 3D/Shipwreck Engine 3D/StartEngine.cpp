...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    if (!startEng.xrInstance.SetupXR()) {
        exit(5325);
    }
    ...
    while (!exitedProgram && !glfwWindowShouldClose(window))
    {
        ...
        startEng.xrInstance.ProcessFrameInput();
        startEng.xrInstance.PollEvents();
    ...
    startEng.xrInstance.ClearResources();
...
//bool checkExtensionSupport(XrInstance instance, const char* extensionName) {
